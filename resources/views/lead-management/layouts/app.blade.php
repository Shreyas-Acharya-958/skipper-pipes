...
<head>
    ...
    <title>Lead Management - @yield('title')</title>
    ...
    <div class="dashboard-container">
        <div class="sidebar">
            <nav class="nav flex-column">
                <!-- Dashboard -->
                <a class="nav-link{{ request()->routeIs('lead-management.dashboard') ? ' active' : '' }}"
                    href="{{ route('lead-management.dashboard') }}">
        ...
        <div class="content-wrapper">
            ...
            <footer class="footer">
                &copy; {{ date('Y') }} Lead Management Panel
            </footer>
        </div>
    </div>
