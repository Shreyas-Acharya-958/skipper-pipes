                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        id="title" name="title" value="{{ old('title', $company->title) }}" required>
                                    @error('title')
                            ...
                            <div class="col-md-6" style="display:none">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                        id="slug" name="slug" value="{{ old('slug', $company->slug) }}" required>
                                    @error('slug')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('short_description') is-invalid @enderror" id="short_description"
                                        name="short_description" rows="3">{{ old('short_description', $company->short_description) }}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description"
                                        name="meta_description" rows="2">{{ old('meta_description', $company->meta_description) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    @if ($company->page_image)
                                        <div class="mt-2">
                                            <img src="{{ Storage::url($company->page_image) }}" alt="Current Image"
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('is_active') is-invalid @enderror" id="is_active"
                                        ...
                                        <option value="1"
                                            {{ old('is_active', $company->is_active) == '1' ? 'selected' : '' }}>Yes
                                        </option>
                                        <option value="0"
                                            {{ old('is_active', $company->is_active) == '0' ? 'selected' : '' }}>No
                                        </option>
                                    </select>
                                    @error('is_active')
                                        <div class="invalid-feedback">{{ $message }}</div>
