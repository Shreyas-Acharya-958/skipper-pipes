                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" name="robots" class="form-control"
                                            placeholder="index, follow" value="{{ old('robots', $blog->robots ?? '') }}">
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" name="og_type" class="form-control"
                                            ...
                                            value="{{ old('og_type', $blog->og_type ?? '') }}">
                                    </div>

                                    <div class="col-12 mb-2">
                                        <label class="form-label">OG Description</label>
                                        <textarea name="og_description" class="form-control">{{ old('og_description', $blog->og_description ?? '') }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-12 mb-2">
                                        ...
                                        @if (!empty($meta->og_image))
                                            <small class="text-muted">Current: {{ $blog->og_image }}</small>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="text" name="twitter_card" class="form-control"
                                            ...
                                            value="{{ old('twitter_card', $blog->twitter_card ?? '') }}">
                                    </div>

                                    <div class="col-12 mb-2">
                                        <label class="form-label">Twitter Description</label>
                                        <textarea name="twitter_description" class="form-control">{{ old('twitter_description', $blog->twitter_description ?? '') }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-12 mb-2">
                                        ...
                                        @if (!empty($meta->twitter_image))
                                            <small class="text-muted">Current: {{ $blog->twitter_image }}</small>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-12 mb-2">
                                        ...
                                        <textarea name="custom_schema_json" class="form-control" rows="5" placeholder='Paste custom JSON schema here'>
                                            {{ old('custom_schema_json', $blog->custom_schema_json ?? '') }}
                                        </textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('modified_at', optional($blog->modified_at)->format('Y-m-d H:i')) }}">
                                    @error('modified_at')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
