        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create New Media</h4>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('media_type') is-invalid @enderror" id="media_type"
                                        ...
                                        <option value="Company" {{ old('media_type') == 'Company' ? 'selected' : '' }}>
                                            Company</option>
                                        <option value="Events" {{ old('media_type') == 'Events' ? 'selected' : '' }}>Events
                                        </option>
                                        <option value="Awards" {{ old('media_type') == 'Awards' ? 'selected' : '' }}>Awards
                                        </option>
                                    </select>
                                    @error('media_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('file_type') is-invalid @enderror" id="file_type"
                                        ...
                                        <option value="youtube_link"
                                            {{ old('file_type') == 'youtube_link' ? 'selected' : '' }}>YouTube Link
                                        </option>
                                    </select>
                                    @error('file_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3" id="file_input_group">
                                    ...
                                    <input type="file" class="form-control @error('file') is-invalid @enderror"
                                        id="file" name="file">
                                    <input type="text" class="form-control @error('file') is-invalid @enderror d-none"
