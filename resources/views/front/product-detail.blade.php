...
@section('content')
    ...
    @if (
        $product->productionOverviewSection &&
            ($product->productionOverviewSection->overview_description ||
                $product->productionOverviewSection->overview_image))
                                    ...
                                    @foreach ($images as $index => $image)
                                        <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                                            <img class="d-block w-100 shadow" src="{{ asset('storage/' . $image) }}"
                                                alt="{{ image_alt_text('storage/' . $image, 'Slide ' . ($index + 1)) }}">
                                        </div>
                                    @endforeach
                                </div>
    ...
    @if ($product->productionFeaturesSections && $product->productionFeaturesSections->count() > 0)
    ...
    @if ($product->technical && !empty(trim($product->technical)))
    ...
    <!-- Product Application -->
    @if ($product->productionApplicationSections && $product->productionApplicationSections->count() > 0)
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6" data-aos="flip-right" data-aos-duration="1000"
                            ...
                            <div class="services-one__single">
                                <div class="services-one__img-box">
                                    ...
                                    <div class="services-one__icon"><img
    ...
    <!-- Product Faq  -->
    @if ($product->productionFaqSections && $product->productionFaqSections->count() > 0)
