...
@section('title', 'Skipper Pipes - Become Dealer')
@section('styles')
    <style>
        .error {
            color: red;
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="image-display col-md-6" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                    <img src="{{ $initialImage }}" id="tab-image" alt="{{ image_alt_text(str_replace([asset(''), url('')], '', $initialImage), 'Image') }}" class="img-fluid shadow" />
                </div>
            </div>
        </div>
    </section>
