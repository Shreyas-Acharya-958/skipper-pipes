...
e(".home-products__carousel").each((function(){var a=e(this),t=a.find(".item").length;a.owlCarousel({items:1,margin:30,smartSpeed:700,loop:t>1,// âœ… Enable loop only if more than 1 item
...
// window scroll event
e(window).on("scroll",(function(){if(e(".stricked-menu").length){var a=e(".stricked-menu");e(window).scrollTop()>130?a.addClass("stricky-fixed"):e(this).scrollTop()<=130&&a.removeClass("stricky-fixed")}if(e(".scroll-to-top").length){e(window).scrollTop()>100?e(".scroll-to-top").fadeIn(500):e(this).scrollTop()<=100&&e(".scroll-to-top").fadeOut(500)}OnePageMenuScroll()}));const a=new IntersectionObserver((function(a){a.forEach((function(a){a.isIntersecting?e(a.target).addClass("show"):e(a.target).removeClass("show")}))}),{threshold:.3});e(".main-blogs-grid .blog-items .item").each((function(){a.observe(this)})),e(".business-dir-card").each((function(){a.observe(this)})),e(".business-heads-card").each((function(){a.observe(this)})),e(".certificate-col").each((function(){a.observe(this)}));
